...
<body> 
	...
	<script> 
        ...
        function sendUpdatedTable() {
        
          // Get updated table data
          const updatedTable = document.getElementById('tableId').innerHTML; 
          
          // Send updated table to server
          fetch('http://localhost:8080/update-timetable', {
            method: 'POST',
            headers: {
          ...
          .catch(error => {
            console.error('Error sending updated table:', error); 
          });
